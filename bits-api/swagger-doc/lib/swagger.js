...
(function() {
  ...
  SwaggerModel = (function() {
    ...
    SwaggerModel.prototype.getMockSignature = function(prefix, modelsToIgnore) {
      ...
      returnVal = classOpen + '<span class="property">' + propertiesStr.join('</span><span class="property">') + '</span>' + classClose;
      if (prefix != null) {
  ...
  SwaggerModelProperty = (function() {
    ...
    SwaggerModelProperty.prototype.toString = function() {
      var str;
      var extraClass = this.required === true ? ' required' : '';
      str = '<span class="property-def'+ extraClass + '">' + this.name + ': ' + this.dataTypeWithRef;
      if (this.values != null) {
      ...
      str += '</span>';
      if (this.descr != null) {
        str += ' - <span class="property-desc">' + this.descr + '</span>';
      }
      return str;
    };
